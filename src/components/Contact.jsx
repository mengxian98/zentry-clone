...
const Contact = () => {
  return (
    <div className="w-full bg-blue-75 px-5 sm:px-10 pt-50 pb-10">
      <div className="relative bg-black text-white rounded-lg py-36 md:py-24 xl:py-28">
        ...
        <div className="absolute h-full w-3/5 sm:w-1/4 xl:w-1/5 top-0 left-[20%] sm:left-[10%] xl:left-[13%] flex flex-col justify-end sm:justify-between overflow-hidden">
          <div className="hidden sm:block contact-image-fire h-1/3 translate-y-[-10%]">
            <img className="scale-150" src="./img/contact-1.webp"></img>
          </div>
          <div className="contact-image-stone h-1/3 translate-y-[30%] md:translate-y-0">
            <img
        ...
        <div className="contact-image-swordsman absolute h-7/10 w-4/5 sm:h-4/5 sm:w-1/4 top-[-32%] sm:top-[10%] xl:top-[-5%] right-[10%] sm:right-[2%]">
          <img
